          ...
          <div className="text-white">
            ...
            <div className="mt-10 flex items-center gap-10 border-t border-white/10 pt-8">
              <div className="text-center">
                ...
                <p className="mt-2 font-ui text-xs font-semibold uppercase tracking-wider text-white/80">Team Stability</p>
              </div>
              <div className="text-center">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="mx-auto text-white" aria-hidden="true">
                ...
                <p className="mt-2 font-ui text-xs font-semibold uppercase tracking-wider text-white/80">Founded in 2015</p>
              </div>
              <div className="text-center">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="mx-auto text-white" aria-hidden="true">
                ...
                <p className="mt-2 font-ui text-xs font-semibold uppercase tracking-wider text-white/80">Trusted Partner</p>
              </div>
            </div>
          </div>
