    ...
    <>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-6 prose prose-lg max-w-none text-dark/80 [&_h2]:font-heading [&_h2]:text-primary-blue [&_h2]:text-2xl [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:font-heading [&_h3]:text-dark [&_h3]:text-lg [&_h3]:mt-8 [&_h3]:mb-3">
          ...
          <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:office@pomerico.com">office@pomerico.com</a>.</p>

          <h2>Summary of Key Points</h2>
          <p><em>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by reading the full notice below.</em></p>
          <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Pomerico Group and the Services, the choices you make, and the products and features you use.</p>
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:office@pomerico.com">office@pomerico.com</a>.</p>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-primary-blue/5">
                  <th className="border border-dark/20 px-3 py-2 text-left">Category</th>
                  <th className="border border-dark/20 px-3 py-2 text-left">Examples</th>
                  <th className="border border-dark/20 px-3 py-2 text-left">Collected</th>
                </tr>
              </thead>
              <tbody>
                <tr><td className="border border-dark/20 px-3 py-2">A. Identifiers</td><td className="border border-dark/20 px-3 py-2">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">B. Personal information categories listed in the California Customer Records statute</td><td className="border border-dark/20 px-3 py-2">Name, contact information, education, employment, employment history, and financial information</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">C. Protected classification characteristics under California or federal law</td><td className="border border-dark/20 px-3 py-2">Gender and date of birth</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">D. Commercial information</td><td className="border border-dark/20 px-3 py-2">Transaction information, purchase history, financial details, and payment information</td><td className="border border-dark/20 px-3 py-2">YES</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">E. Biometric information</td><td className="border border-dark/20 px-3 py-2">Fingerprints and voiceprints</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">F. Internet or other similar network activity</td><td className="border border-dark/20 px-3 py-2">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">G. Geolocation data</td><td className="border border-dark/20 px-3 py-2">Device location</td><td className="border border-dark/20 px-3 py-2">YES</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">H. Audio, electronic, visual, thermal, olfactory, or similar information</td><td className="border border-dark/20 px-3 py-2">Images and audio, video or call recordings created in connection with our business activities</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">I. Professional or employment-related information</td><td className="border border-dark/20 px-3 py-2">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td><td className="border border-dark/20 px-3 py-2">YES</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">J. Education Information</td><td className="border border-dark/20 px-3 py-2">Student records and directory information</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
                <tr><td className="border border-dark/20 px-3 py-2">K. Inferences drawn from other personal information</td><td className="border border-dark/20 px-3 py-2">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual&apos;s preferences and characteristics</td><td className="border border-dark/20 px-3 py-2">NO</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>Pomerico Group Sp. z o.o. has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Pomerico Group Sp. z o.o. will not sell personal information in the future belonging to website visitors, users, and other consumers.</p>
          ...
          <p>If you have questions or comments about this notice, you may email us at <a href="mailto:office@pomerico.com">office@pomerico.com</a> or by post to:</p>
          <p>
          ...
          <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us at <a href="mailto:office@pomerico.com">office@pomerico.com</a>.</p>
        </div>
      </section>
    </>
  );
